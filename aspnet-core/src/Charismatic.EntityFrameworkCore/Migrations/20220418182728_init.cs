        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    numeric_code = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    ...
                    WikiDataId = table.Column<string>(type: "nvarchar(191)", maxLength: 191, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResponsipleName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResponsiplePhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationCase", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncisalEdge = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeethColors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UpperRightLength = table.Column<int>(type: "int", nullable: true),
                    UpperRightLateredLength = table.Column<int>(type: "int", nullable: true),
                    UpperRightCanineLength = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_teethLengths", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "CaseTypeDepartmentWorkFlows",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CaseTypeDepartmentWorkFlows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CaseTypeDepartmentWorkFlows_CaseTypes_CaseTypeId",
                        column: x => x.CaseTypeId,
                        principalTable: "CaseTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CaseTypeDepartmentWorkFlows_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttachmentExtensions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttachmentExtensions_AttachmentTypes_AttachmentTypeId",
                        column: x => x.AttachmentTypeId,
                        principalTable: "AttachmentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttachmentExtensions_Extensions_ExtensionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CaseTypeProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CaseTypeProduct_CaseTypes_CaseTypeId",
                        column: x => x.CaseTypeId,
                        principalTable: "CaseTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CaseTypeProduct_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DoctorSpecialties_Specialties_SpecialtyId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientReferrais", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientReferrais_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatientReferrais_States_StateId",
                        column: x => x.StateId,
                        principalTable: "States",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorCenters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorCenters_Centers_CenterId",
                        column: x => x.CenterId,
                        principalTable: "Centers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DoctorCenters_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PatientReferraisId = table.Column<int>(type: "int", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    LevelUpperLipRElationToIncisors = table.Column<int>(type: "int", nullable: true),
                    AmontIncisorsOnRestPostionUpper = table.Column<double>(type: "float", nullable: true),
                    AmontIncisorsOnRestPostionLower = table.Column<double>(type: "float", nullable: true),
                    DesiredTeethPropWidthToHeight = table.Column<double>(type: "float", nullable: true),
                    IsSpecific = table.Column<bool>(type: "bit", nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PhydicalImpresssion = table.Column<bool>(type: "bit", nullable: true),
                    DigitalImpression = table.Column<bool>(type: "bit", nullable: true),
                    TypeId = table.Column<int>(type: "int", nullable: true),
                    EvaluationCaseId = table.Column<int>(type: "int", nullable: true),
                    Type = table.Column<int>(type: "int", nullable: false),
                    CaseStatus = table.Column<int>(type: "int", nullable: false),
                    CaseEvaluationType = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cases_EvaluationCase_EvaluationCaseId",
                        column: x => x.EvaluationCaseId,
                        principalTable: "EvaluationCase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cases_PatientReferrais_PatientReferraisId",
                        column: x => x.PatientReferraisId,
                        principalTable: "PatientReferrais",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Inclination = table.Column<int>(type: "int", nullable: true),
                    SmileLine = table.Column<int>(type: "int", nullable: true),
                    SmileWidth = table.Column<int>(type: "int", nullable: true),
                    LabiaCorridor = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvancedAs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvancedAs_Cases_CaseId",
                        column: x => x.CaseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LowerTeeth = table.Column<double>(type: "float", nullable: true),
                    FaceMidline = table.Column<double>(type: "float", nullable: true),
                    UpperTeeth = table.Column<double>(type: "float", nullable: true),
                    CaseId = table.Column<int>(type: "int", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_advancedBs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_advancedBs_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CaseDepartmentExcludeds",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CaseId = table.Column<int>(type: "int", nullable: true),
                    CaseTypeDepartmentWorkFlowId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CaseDepartmentExcludeds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CaseDepartmentExcludeds_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CaseDepartmentExcludeds_CaseTypeDepartmentWorkFlows_CaseTypeDepartmentWorkFlowId",
                        column: x => x.CaseTypeDepartmentWorkFlowId,
                        principalTable: "CaseTypeDepartmentWorkFlows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CaseProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CaseProducts_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CaseProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMyreland = table.Column<bool>(type: "bit", nullable: true),
                    IsPontics = table.Column<bool>(type: "bit", nullable: true),
                    IsCrown = table.Column<bool>(type: "bit", nullable: true),
                    IsVeneers = table.Column<bool>(type: "bit", nullable: true),
                    IsPost = table.Column<bool>(type: "bit", nullable: true),
                    IsDoubleCrown = table.Column<bool>(type: "bit", nullable: true),
                    MatrialId = table.Column<int>(type: "int", nullable: false),
                    Shape = table.Column<int>(type: "int", nullable: true),
                    Texture = table.Column<int>(type: "int", nullable: true),
                    LengthId = table.Column<int>(type: "int", nullable: true),
                    Translucence = table.Column<int>(type: "int", nullable: true),
                    StumpShade = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeethCases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeethCases_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeethCases_Matrials_MatrialId",
                        column: x => x.MatrialId,
                        principalTable: "Matrials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeethCases_TeethColors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "TeethColors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeethCases_Teeths_TeethId",
                        column: x => x.TeethId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderEmp = table.Column<int>(type: "int", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MissionMembers_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvancedAs_CaseId",
                table: "AdvancedAs",
                column: "CaseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_advancedBs_CaseId",
                table: "advancedBs",
                column: "CaseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AttachmentExtensions_AttachmentTypeId",
                table: "AttachmentExtensions",
                column: "AttachmentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AttachmentExtensions_ExtensionId",
                table: "AttachmentExtensions",
                column: "ExtensionId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseDepartmentExcludeds_CaseId",
                table: "CaseDepartmentExcludeds",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseDepartmentExcludeds_CaseTypeDepartmentWorkFlowId",
                table: "CaseDepartmentExcludeds",
                column: "CaseTypeDepartmentWorkFlowId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseProducts_CaseId",
                table: "CaseProducts",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseProducts_ProductId",
                table: "CaseProducts",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cases_EvaluationCaseId",
                table: "Cases",
                column: "EvaluationCaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Cases_PatientReferraisId",
                table: "Cases",
                column: "PatientReferraisId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseTypeDepartmentWorkFlows_CaseTypeId",
                table: "CaseTypeDepartmentWorkFlows",
                column: "CaseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseTypeDepartmentWorkFlows_DepartmentId",
                table: "CaseTypeDepartmentWorkFlows",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseTypeProduct_CaseTypeId",
                table: "CaseTypeProduct",
                column: "CaseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CaseTypeProduct_ProductId",
                table: "CaseTypeProduct",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorCenters_CenterId",
                table: "DoctorCenters",
                column: "CenterId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorCenters_DoctorId",
                table: "DoctorCenters",
                column: "DoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionMembers_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Missions_CaseId",
                table: "Missions",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientReferrais_CountryId",
                table: "PatientReferrais",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientReferrais_StateId",
                table: "PatientReferrais",
                column: "StateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeethCases_CaseId",
                table: "TeethCases",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_TeethCases_ColorId",
                table: "TeethCases",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_TeethCases_MatrialId",
                table: "TeethCases",
                column: "MatrialId");

            migrationBuilder.CreateIndex(
                name: "IX_TeethCases_TeethId",
                table: "TeethCases",
                column: "TeethId");
        }
