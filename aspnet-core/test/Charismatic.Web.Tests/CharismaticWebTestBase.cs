...
using Charismatic.Models.TokenAuth;
...
{
    public abstract class CharismaticWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CharismaticWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CharismaticWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<CharismaticDbContext> action)
        {
            using (var context = IocManager.Resolve<CharismaticDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<CharismaticDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<CharismaticDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CharismaticDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CharismaticDbContext, Task<T>> func)
        {
            T result;
